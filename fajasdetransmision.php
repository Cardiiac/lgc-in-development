            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="producto-hero-content">
                        <h1 class="producto-titulo">FAJAS DE TRANSMISION</h1>
                        ...
                        <div class="producto-acciones">
                            <a href="#contacto" class="btn btn-primary btn-lg">Solicitar Cotización</a>
                            <a href="tel:912920272" class="btn btn-outline-primary btn-lg">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="info-card">
                        ...
                        <ul>
                            ...
                            <li>Rodamientos especiales</li>
                            <li>Diversas medidas disponibles</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
